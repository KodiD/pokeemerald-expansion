...
const u8 gText_RepelCharmOn[] = _("The Repel Charm is now turned ON!{PAUSE_UNTIL_PRESS}"); // orgainze Later
const u8 gText_RepelCharmOff[] = _("The Repel Charm is now turned OFF!{PAUSE_UNTIL_PRESS}");// orgainze Later
...
const u8 gText_ExpGain[] = _("GAIN EXP");
const u8 gText_ClockColor[] = _("CLOCK COLOR");
...
const u8 gText_ExpGainOn[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}ON");
const u8 gText_ExpGainOff[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}OFF");
const u8 gText_ClockColorBlue[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}BLUE");
const u8 gText_ClockColorPink[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}PINK");
