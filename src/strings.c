...
const u8 gText_RepelCharmOn[] = _("The Repel Charm is now turned ON!"); // orgainze Later
const u8 gText_RepelCharmOff[] = _("The Repel Charm is now turned OFF!");// orgainze Later
