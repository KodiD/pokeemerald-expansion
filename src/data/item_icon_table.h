const u32 *const gItemIconTable[ITEMS_COUNT + 1][2] =
{
    ...
    [ITEM_LEVEL_STONE] = {gItemIcon_DawnStone, gItemIconPalette_DynamaxCandy},
    [ITEM_EXP_CAP_CORE_RE] = {gItemIcon_IceStone, gItemIconPalette_DynamaxCandy},
    [ITEM_EXP_CAP_CORE] = {gItemIcon_IceStone, gItemIconPalette_DynamaxCandy},
    // Medicinal Flutes
    ...
    // Treasures
    [ITEM_EV_STONE] = {gItemIcon_DuskStone, gItemIconPalette_MaxLure},
    [ITEM_IV_STONE] = {gItemIcon_ShinyStone, gItemIconPalette_MaxRepel},
    ...
    [ITEM_REPEL_CHARM] = {gItemIcon_ExpCharm, gItemIconPalette_ExpCharm},
