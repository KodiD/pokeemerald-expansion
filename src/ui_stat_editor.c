...
static const u8 sText_MenuAttackPlus[] = _("Attack +");
static const u8 sText_MenuSpAttackPlus[] = _("Sp. Atk +");
static const u8 sText_MenuDefensePlus[] = _("Defense +");
static const u8 sText_MenuSpDefensePlus[] = _("Sp. Def +");
static const u8 sText_MenuSpeedPlus[] = _("Speed +");
static const u8 sText_MenuAttackMinus[] = _("Attack -");
static const u8 sText_MenuSpAttackMinus[] = _("Sp. Atk -");
static const u8 sText_MenuDefenseMinus[] = _("Defense -");
static const u8 sText_MenuSpDefenseMinus[] = _("Sp. Def -");
static const u8 sText_MenuSpeedMinus[] = _("Speed -");
...
static void PrintMonStats()
{
    ...
    //Attack
    if(nature==NATURE_ADAMANT || nature==NATURE_BRAVE ||nature==NATURE_LONELY ||nature==NATURE_NAUGHTY){
        AddTextPrinterParameterized4(WINDOW_2, FONT_NARROW, 8, STARTING_Y + (DISTANCE_BETWEEN_STATS_Y * 1), 0, 0, sMenuWindowFontColors[FONT_RED], 0xFF, sText_MenuAttackPlus);
    }else if (nature==NATURE_BOLD || nature==NATURE_TIMID ||nature==NATURE_MODEST ||nature==NATURE_CALM)
    {
        AddTextPrinterParameterized4(WINDOW_2, FONT_NARROW, 8, STARTING_Y + (DISTANCE_BETWEEN_STATS_Y * 1), 0, 0, sMenuWindowFontColors[FONT_BLUE], 0xFF, sText_MenuAttackMinus);
    }else{
    ...
    //SPeed
    if(nature==NATURE_TIMID || nature==NATURE_HASTY ||nature==NATURE_JOLLY ||nature==NATURE_NAIVE){
        AddTextPrinterParameterized4(WINDOW_2, FONT_NARROW, 12, STARTING_Y + (DISTANCE_BETWEEN_STATS_Y * 5), 0, 0, sMenuWindowFontColors[FONT_RED], 0xFF, sText_MenuSpeedPlus);
    }else if (nature==NATURE_BRAVE || nature==NATURE_RELAXED ||nature==NATURE_QUIET ||nature==NATURE_SASSY)
    {
        AddTextPrinterParameterized4(WINDOW_2, FONT_NARROW, 12, STARTING_Y + (DISTANCE_BETWEEN_STATS_Y * 5), 0, 0, sMenuWindowFontColors[FONT_BLUE], 0xFF, sText_MenuSpeedMinus);
    }else{
    ...
    for(i = 0; i < 6; i++)
    {
        ...
        AddTextPrinterParameterized4(WINDOW_2, 1, StatPrintData[statsToPrintActual[i]].x, StatPrintData[statsToPrintActual[i]].y, 0, 0, sMenuWindowFontColors[FONT_GRAY], 0xFF, gStringVar2);
    }
    ...
    for(i = 0; i < 6; i++)
    {
        ...
        if(sStatEditorDataPtr->selector_x==0){
            ...
            AddTextPrinterParameterized4(WINDOW_2, 1, StatPrintData[statsToPrintEVs[i]].x, StatPrintData[statsToPrintEVs[i]].y, 0, 0, sMenuWindowFontColors[FONT_GRAY], 0xFF, gStringVar2);
        }
    }
    ...
    for(i = 0; i < 6; i++)
    {
        ...
        ConvertIntToDecimalStringN(gStringVar2, currentStat, STR_CONV_MODE_RIGHT_ALIGN, 3);
        if(sStatEditorDataPtr->selector_x==0){
            AddTextPrinterParameterized4(WINDOW_2, 1, StatPrintData[statsToPrintIVs[i]].x, StatPrintData[statsToPrintIVs[i]].y, 0, 0, sMenuWindowFontColors[FONT_GRAY], 0xFF, gStringVar2);
        }else{
    ...
    AddTextPrinterParameterized4(WINDOW_2, 1, STARTING_X - 6, STARTING_Y + (DISTANCE_BETWEEN_STATS_Y * 6), 0, 0, sMenuWindowFontColors[FONT_GRAY], 0xFF, gStringVar2);
    ...
    if(sStatEditorDataPtr->selector_x==0){
        ...
        AddTextPrinterParameterized4(WINDOW_2, 1, STARTING_X + SECOND_COLUMN, STARTING_Y + (DISTANCE_BETWEEN_STATS_Y * 6), 0, 0, sMenuWindowFontColors[FONT_GRAY], 0xFF, gStringVar2);
    }

    ConvertIntToDecimalStringN(gStringVar2, sStatEditorDataPtr->ivTotal, STR_CONV_MODE_RIGHT_ALIGN, 3);
    if(sStatEditorDataPtr->selector_x==0){
        AddTextPrinterParameterized4(WINDOW_2, 1, STARTING_X + THIRD_COLUMN, STARTING_Y + (DISTANCE_BETWEEN_STATS_Y * 6), 0, 0, sMenuWindowFontColors[FONT_GRAY], 0xFF, gStringVar2);
    }else{
