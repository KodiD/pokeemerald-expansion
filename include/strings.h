...
extern const u8 gText_ExpGainOn[];
extern const u8 gText_ExpGainOff[];
extern const u8 gText_ClockColorBlue[];
extern const u8 gText_ClockColorPink[];
...
extern const u8 gText_ExpGain[];
extern const u8 gText_ClockColor[];
...
extern const u8 gText_RepelCharmOn[]; //orgainze Later?
extern const u8 gText_RepelCharmOff[]; //orgainze Later?
